        ...
        <div className="w-full px-4">
          ...
          <div className="max-w-7xl mx-auto p-4 md:p-6 border border-gray-300 rounded-lg">
            <div className="grid grid-cols-1 md:grid-cols-10 gap-0 items-center w-full">
              {/* Left Column - Headings Only (30%) */}
              <div className="md:col-span-3 space-y-4 text-right mr-[12%]">
              ...
              {/* Right Column - Map (40%) */}
              <div className="md:col-span-4 w-full h-64 md:h-80 rounded-lg overflow-hidden">
                <iframe
