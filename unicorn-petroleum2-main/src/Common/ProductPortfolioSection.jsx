      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="relative">
          ...
          <div
            ...
            className="flex gap-4 sm:gap-6 md:gap-8 overflow-x-auto scrollbar-hide py-1"
            style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}
          >
            {data.cards.map((card, index) => (
              <div key={index} className="flex-shrink-0 basis-full sm:basis-1/2 lg:basis-1/3 xl:basis-1/4 min-w-0">
                <Link to={card.link || "/products"} className="bg-white h-[430px] rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 group cursor-pointer border-[1.5px] border-[#EDA94E] flex flex-col">
                  ...
                  <div className="p-4 sm:p-5 md:p-6 flex flex-col flex-grow text-center sm:text-left">
                    ...
                    <span className="bg-[#E99322] hover:bg-[#E99322]/90 text-white px-3 sm:px-4 py-1.5 sm:py-2 rounded-full font-medium text-xs sm:text-sm transition-all duration-300 hover:shadow-lg mt-auto inline-flex items-center mx-auto sm:mx-0">
                      {card.buttonText}
                    </span>
                  </div>
                </Link>
