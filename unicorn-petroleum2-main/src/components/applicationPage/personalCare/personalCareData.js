export const personalCareData = {
  ...
  relatedProducts: [
    ...
    { name: 'Natural Beeswax', image: '/assets/RELATED PROD IMG/NEW IMAGES/Naturalbeeswax.jpg', hoverImage: '/assets/RELATED PROD IMG/New Hover Images/waxes.jpg', description: 'Used in lotions, creams and lip balms for its emollient and protective benefits' },
