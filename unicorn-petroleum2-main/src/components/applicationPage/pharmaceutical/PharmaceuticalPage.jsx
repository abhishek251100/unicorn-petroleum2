  ...
  const products = [
    {
      ...
      description: "Base for ointments, eye gels, topical formulations",
      image: "/assets/RELATED PROD IMG/Petroleum jelly.png"
    },
    {
      name: "White Mineral Oils",
      description: "Laxative formulations, oral liquid carriers",
      image: "/assets/RELATED PROD IMG/Mineral Oil.png"
    },
    {
      name: "Microcrystalline Wax",
      description: "Used in manufacturing balms",
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <BannerWithNavigation
        ...
        currentPath="/applications/pharmaceutical"
