    ...
    <ApplicationTemplate
      ...
      data={{
        ...
        relatedProducts: [
          ...
          { name: 'Hard Paraffin Wax', link: '/products/paraffin-wax', image: '/assets/RELATED PROD IMG/NEW IMAGES/paraffinwax.jpg', hoverImage: '/assets/RELATED PROD IMG/New Hover Images/paraffin2.jpg', description: 'Used in creams, ointments, balms, and lip care products.' },
          ...
          { name: 'Lanolin', link: '/products/lanolin', image: '/assets/RELATED PROD IMG/NEW IMAGES/lanolin.jpg', hoverImage: '/assets/RELATED PROD IMG/NEW IMAGES/lanolin.jpg', description: 'Refined wool grease used as a skin-conditioning excipient in cosmetic and topical formulations.' },
