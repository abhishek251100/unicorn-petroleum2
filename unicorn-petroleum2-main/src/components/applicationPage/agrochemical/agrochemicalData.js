export const agrochemicalData = {
  hero: { title: 'Agrochemical Applications', description: 'Consistent inputs for crop care formulations' },
  slider: [
    { title: 'Agrochemical Applications', subtitle: 'Consistent inputs for crop care formulations', image: '/assets/BannerImages/applications%20desktop.jpg', mobileImage: '/assets/BannerImages/applications%20mobile.jpg' },
  ],
  overview: {
    title: 'Tailored for agrochemical products',
    description:
      'Agrochemical products need to perform under tough environmental conditions. Our base materials—such as mineral oils and waxes—enhance formulation stability, delivery efficiency, and surface adhesion in pesticides, fertilizers, and plant protection products.',
  },
  relatedProducts: [
    ...
    { name: 'Paraffin Wax', image: '/assets/RELATED PROD IMG/NEW IMAGES/paraffinwax.jpg', hoverImage: '/assets/RELATED PROD IMG/New Hover Images/paraffin2.jpg', description: 'Used as coating agents for fertilizers' },
...
export default agrochemicalData;
