export const agrochemicalData = {
  ...
  relatedProducts: [
    ...
    { name: 'Paraffin Wax', image: '/assets/RELATED PROD IMG/NEW IMAGES/paraffinwax.jpg', hoverImage: '/assets/RELATED PROD IMG/New Hover Images/waxes.jpg', description: 'Used as coating agents for fertilizers' },
